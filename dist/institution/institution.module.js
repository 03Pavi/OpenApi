...
let InstitutionModule = exports.InstitutionModule = class InstitutionModule {
};
exports.InstitutionModule = InstitutionModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: institution_schema_1.Institution.name, schema: institution_schema_1.InstitutionSchema }])],
