...
export declare class InstitutionService {
    ...
    create(createInstitution: CreateInstitutionDto): Promise<Institution>;
    findAll(): Promise<Institution[]>;
    findOne(id: string): Promise<Institution>;
    update(updateInstitution: UpdateInstitutionDto): Promise<import("mongoose").Document<unknown, {}, Institution> & Institution & {
